		...
		<div id="wrapper">
			...
			<div class="content">
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-12">
							<h4 class="pull-left page-title"><?php echo (@$this->uri->segment(4)?'EDIT MSO':'ADD MSO');?></h4>
							<button class="btn btn-primary pull-right" onclick="location.href='<?php echo base_url('cable/mso');?>'">Back</button>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
									...
									<div class="row">
										...
										<form method="post" id="form">
											...
											<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
												<div class="your-mail">
													<label for="exampleInputEmail1">MSO Name<span class="text-danger">*</span></label>
