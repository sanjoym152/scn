							...
							<div class="col-md-12">
								...
								<div class="panel panel-default">
									<div class="panel-body table-rep-plugin">
										<div class="panel panel-default">
										<div class="panel-heading">Search from date and to date and keyword etc.</div>
													...
													<table id="datatable" class="table table-striped table-bordered">
														...
														<tbody>
															...
															if(@$customer_details){
																...
																<tr>
																	<td><?php echo @$i++;?></td>
																	<td>Cust Code: <?php echo @$row['cust_code'];?><br>Other ID: <?php echo @$row['area_name'].'-'.@$row['other_id'];?></td>
																	...
																	<td><?php echo @$row['stb_date'];?></td>
																	<td><?php echo @$row['stb_amount'];?></td>
																</tr>
																<?php 
																}
															}else{
