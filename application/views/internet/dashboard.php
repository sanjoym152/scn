...
<html>
	...
	<body class="fixed-left">
								...
								<div class="card mb-3">
									...
									<div class="card-body">
										...
										<div class="row table-responsive before_select">
											<h5 class="text-center">Select a year to view customer payment details</h5>
										</div>
									</div>
							...
							<div class="col-md-12">
								<div class="col-md-3">
									...
									<div class="your-mail">
										...
										<input type="text" name="remark" class="required form-control" placeholder="Enter description of month.">
		...
		$( function() {
			$( "#autocomplete" ).autocomplete({
				source: function( request, response ) {
					$.ajax({
						url:'<?php echo base_url('internet/home/autocomplete')?>',
						method:'post',
						dataType: "json",
						data: {
				...
				select: function( event, ui ) {
					...
					$.ajax({
						url:'<?php echo base_url('internet/home/get_customer_details')?>',
						method:'post',
						dataType: "json",
						data: {
			...
			$('.year').change(function(){
				...
				console.log(cust_id);
				$.ajax({
					url:'<?php echo base_url('internet/home/get_payment_info');?>',
					method:'post',
					data:{
						customer_id:cust_id,
						year:year
			...
			*/
			...
			$('body').on('click', '.delete_payment', function(){
				if(confirm('Are you sure?')){
					...
					$.ajax({
						method:'post',
						url: '<?php echo base_url('internet/payment/delete_payment')?>',
			...
			$('body').on('click', '.edit_payment', function(){
				...
				var customer_id = $(this).data('customer_id');
				$.ajax({
					url:'<?php echo base_url('internet/home/get_payment_data')?>',
					method:'post',
					data:{
					...
					success:function(result){
						...
						$('.month_of').val(result.payment_data.remark);
		...
		<div id="edit_payment" class="modal fade" role="dialog">
			...
			<!-- Modal content-->
				<div class="modal-content">
					<form id="payment_form" autocomplete="off" method="post" action="<?php echo base_url('internet/payment/edit_payment')?>">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal">&times;</button>
						...
						<div class="modal-body" style="float:left">
							...
							<div class="col-md-12">
								<div class="col-md-4">
									...
									<div class="your-mail">
										<label for="exampleInputEmail1">Description</label>
										<input type="text" name="remark" class="month_of required form-control" placeholder="Enter description of month.">
									</div>
								</div>
								<div class="col-md-4">
									<div class="your-mail">
